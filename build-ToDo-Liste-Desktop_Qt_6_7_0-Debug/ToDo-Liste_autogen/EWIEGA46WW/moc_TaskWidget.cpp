...
#include "../../../ToDo-Liste/TaskWidget.h"
...
Q_CONSTINIT const QMetaObject TaskWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTaskWidgetENDCLASS_t,
        ...
        // method 'completeRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<TaskWidget *, std::false_type>,
        // method 'onRemoveButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onCompleteButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void TaskWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->removeRequested((*reinterpret_cast< std::add_pointer_t<TaskWidget*>>(_a[1]))); break;
        case 1: _t->completeRequested((*reinterpret_cast< std::add_pointer_t<TaskWidget*>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TaskWidget::removeRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TaskWidget::*)(TaskWidget * );
            if (_t _q_method = &TaskWidget::completeRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TaskWidget::removeRequested(TaskWidget * _t1)
{
...
// SIGNAL 1
void TaskWidget::completeRequested(TaskWidget * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
